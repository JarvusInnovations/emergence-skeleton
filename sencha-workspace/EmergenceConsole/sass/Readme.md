...
folder are mapped to the application's root namespace, 'EmergenceConsole'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "EmergenceConsole"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'EmergenceConsole' in the same way
as `"EmergenceConsole/sass/src"`.
