 ...
 */
 /**
  * Modified by chris.alfano@devnuts.com on 2010-01-24
  * Commented out loader.createNode override in initComponent
  *
  * Modified by chris.alfano@devnuts.com on 2010-02-08
  * Modified initColumns to preserve enableSort config objects
  */
 
declare('Ext::ux::tree::TreeGrid', function(use) {
    use([
    	'Ext::ux::tree::treegrid.css'
    	,'Ext::ux::tree::TreeGridSorter'
    	,'Ext::ux::tree::TreeGridColumnResizer'
    	,'Ext::ux::tree::TreeGridNodeUI'
    	,'Ext::ux::tree::TreeGridLoader'
    	,'Ext::ux::tree::TreeGridColumns'
	]
	,function(use) {
		...
		Ext.ux.tree.TreeGrid = Ext.extend(Ext.tree.TreePanel, {
		    ...
		    initComponent : function() {
		        ...
		        /* // destroys custom loaders, like the package's own TreeGridLoader which tries to do the same thing
		    ...
		    initColumns : function() {
		        ...
		        for(i = 0; i < len; i++){
		            ...
		            if(this.enableSort !== false && c.sortable !== false) {
		                c.sortable = true;
		                this.enableSort = this.enableSort ? this.enableSort : true;
		            }
		        }
