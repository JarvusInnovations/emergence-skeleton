/* PrismJS 1.16.0
https://prismjs.com/download.html?#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+diff+markup-templating+git+http+php+json+nginx+php-extras+powershell+scss+smarty&plugins=line-highlight+line-numbers+file-highlight+toolbar+command-line+normalize-whitespace+copy-to-clipboard */
