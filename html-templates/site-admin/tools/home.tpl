...
{block "content"}
    <div class="row emr-tools">
        <div class="col-xs-6 col-lg-4">
            ...
            <p><a class="btn btn-default" href="/site-admin/tools/precache" role="button">Precache Parent »</a></p>
        </div>
        <div class="col-xs-6 col-lg-4">
        ...
        <div class="col-xs-6 col-lg-4">
            ...
            <p><a class="btn btn-default" href="/site-admin/tools/clear-apc-cache" role="button">Clear APC Cache »</a></p>
        </div>
        <div class="col-xs-6 col-lg-4">
            ...
            <p><a class="btn btn-default" href="/site-admin/tools/migrations" role="button">Migrations »</a></p>
        </div>
        ...
        <div class="col-xs-6 col-lg-4">
            ...
            <p><a class="btn btn-default" href="/site-admin/tools/table-manager" role="button">Table Manager »</a></p>
        </div>
        <div class="col-xs-6 col-lg-4">
            ...
            <p><a class="btn btn-default" href="/site-admin/tools/clear-template-cache" role="button">Clear Template Cache »</a></p>
        </div>
    </div>
{/block}