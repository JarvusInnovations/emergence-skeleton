...
{
    public static $recordClass = 'CMS_Content';
    ...
    public static function handleEditRequest(CMS_Content $Content)
    {
        ...
        if (count($CategoryItems)) {
            ...
            foreach ($CategoryItems as $CategoryItem) {
                if (!in_array($CategoryItem->CategoryID,$data['Categories'])) {
                    // if existing CategoryItem isn't found in the input, destroy it
        ...
        if (count($TagItems)) {
            ...
            foreach ($TagItems as $TagItem) {
                ...
                if (!in_array($Tag->Title,$data['Tags'])) {
                    // if existing Tag isn't found in the input, destroy it's TagItem
