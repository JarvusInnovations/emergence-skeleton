...
namespace Emergence\Dwoo\Plugins;
...
function PluginSenchaBootstrap(Core $dwoo, $App = null, $classPaths = array(), $packages = array(), $patchLoader = true, $framework = 'ext', $frameworkVersion = null, $packageRequirers = null)
{
