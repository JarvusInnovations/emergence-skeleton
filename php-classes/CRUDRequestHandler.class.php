...
abstract class CRUDRequestHandler extends RequestHandler
{
	...
	static public function handleReadRequest()
	{
	...
	static public function handleCreateRequest($data = null)
	{
		if($data == null)
	...
	static protected function createRecord($data)
	{
	...
	static public function handleUpdateRequest($data = null)
	{
		if($data == null)
			$data = static::getRequestData();
	...
	static protected function updateRecord(ActiveRecord $Record, $data)
	{
		$Record->setFields($data);
	}

	static public function handleDeleteRequest()
	{
		if(!$resourceHandle = static::shiftPath())
			return static::throwError('Unique identifier ID or Handle required for PUT operation');
		elseif(!$Record = static::getRecord($resourceHandle))
	...
	static public function getAllRecords($conditions = array(), $options = array())
	{
		$class = static::$recordClass;
	...
	static public function getRecord($resourceHandle)
	{
		$class = static::$recordClass;
	...
	static public function respondCRUD($payload, $count = 'singular', $verb = '', $additional = array(), $responseID = false)
	{
	...
	static public function throwRecordInvalidError(ActiveRecord $Record, $data = null)
	{
	...
	static public function getResponseID($count = 'singular', $verb = '')
	{
		$class = static::$recordClass;
