...
class MinifiedRequestHandler extends RequestHandler
{
	...
	static public function handleAssetsRequest($root, $contentType, $minifier) {
	...
	static public function getSourceCode($minifier, $cacheHashOrSourceReport, $skipCache = false) {
	...
	static public function getSourceReport($paths, $root, $contentType = null) {
	...
	static public function getSourceNodes($paths, $root, $contentType = null) {
	...
	static public function getFilesHash($files) {
		$hashStr = '';
